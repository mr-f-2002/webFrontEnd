...
<div class="attendance-tile" style="background-color: #e5fdff; width: 98%; height: 45px; margin: 2px 0; display: flex; align-items: center; padding: 1%;">
    ...
    <form action="/createAttendance" method="post">
        ...
        <button type="submit"  style="background-color: ${param.colorP}; color: white; font-size: 15px; font-weight: bold; border: none; padding: 5px 10px; margin-right: 5px; cursor: pointer;">P</button>
    </form>
    <form action="/createAttendance" method="post">
        <input type="hidden" name="studentId" value="${param.studentId}">
        <input type="hidden" name="action" value="absent">
        <button type="submit" style="background-color: ${param.colorA}; color: white; font-size: 15px; font-weight: bold; border: none; padding: 5px 10px; cursor: pointer;">A</button>
    </form>
    <script>
